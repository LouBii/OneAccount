 ...
 * @date 2017/10/18
 */
public class CalenderRemind {
    private static final long ONE_HOUR = 60*60*1000l;
    private static final long TEN_MINITE = 10*60*1000l;
    ...
    public static void addCalendarEvent(Context context,String title, String description, long beginTime){
        ...
        mCalendar.setTimeInMillis(start + TEN_MINITE);//设置终止时间
        long end = mCalendar.getTime().getTime();

        event.put(CalendarContract.Events.DTSTART, start);
        event.put(CalendarContract.Events.DTEND, end);
        event.put(CalendarContract.Events.HAS_ALARM, 2);//设置有闹钟提醒
